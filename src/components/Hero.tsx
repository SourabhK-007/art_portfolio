        ...
        <div className="flex h-auto w-full max-w-full flex-col lg:flex-row gap-4 justify-around items-center lg:items-end py-4">
          ...
          <div className="relative h-auto lg:h-[700px] w-full" ref={container}>
            ...
            <div className="absolute inset-0 z-0 flex flex-col lg:flex-row items-center justify-between lg:pl-10 gap-6">
              <h1 className="hero-heading text-white text-stroke font-pirate text-4xl sm:text-4xl md:text-8xl text-center lg:text-left">
                Kalavida&apos;s Atelier
              </h1>
              <div className="flex flex-col sm:flex-row items-center justify-end sm:justify-end gap-4 w-full">
                ...
                <Image
                  ...
                  width={350}
                  height={200}
                  className="ml-auto w-[200px] sm:w-[300px] md:w-[400px] lg:w-[500px] h-auto"
                />
              </div>
            </div>
